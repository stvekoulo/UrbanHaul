    ...
    <ul class="app-menu">
        ...
        <li class="menu-item">
            <a href="index.html" class="menu-link waves-effect">
                ...
                <span class="badge bg-primary rounded-pill ms-auto">01</span>
            </a>
        </li>
        ...
        <li class="menu-item">
            <a href="#menuElements" data-bs-toggle="collapse" class="menu-link waves-effect">
                <span class="menu-icon"><i class="bx bx-cylinder"></i></span>
                <span class="menu-text"> UI Elements </span>
                <span class="menu-arrow"></span>
            </a>
            <div class="collapse" id="menuElements">
                <ul class="sub-menu">
                    <li class="menu-item">
